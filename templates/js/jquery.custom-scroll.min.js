...
!function(t) {
   function i(i, n) {
       function s() {
           v.on("DOMMouseScroll mousewheel", function(i) {
               var o = t(this)
                 ...
                 , e = this.scrollHeight
                 , n = o.height()
                 , s = "DOMMouseScroll" == i.type ? -40 * i.originalEvent.detail : i.originalEvent.wheelDelta
                 , l = s > 0;
       ...
       function l(o, r) {
           i["scroll" + r.Dir](0);
           var e = n.prefix + "bar" + r.suffix
             , s = i.children("." + e);
           s.length || (s = t(n.barHtml).addClass(e).appendTo(i)),
           s.on("mousedown touchstart", function(t) {
               t.preventDefault();
               var i = v["scroll" + r.Dir]()
                 , e = t[r.clientAxis] || t.originalEvent.changedTouches && t.originalEvent.changedTouches[0][r.clientAxis]
                 , n = a(o, r).ratio;
       ...
       function a(t, o) {
           var r = 0 | v.prop("scroll" + o.Dim)
             , e = i["inner" + o.Dim]()
             , s = v["inner" + o.Dim]()
             , l = e - n["offset" + o.Dir] - n["offset" + o.Dir2];
           m["x" == t ? "y" : "x"] || (l -= n["track" + o.Dim]);
           var a = Math.max(l * e / r | 0, n["barMin" + o.Dim])
             , c = (l - a) / (r - s);
           return {
               ratio: c,
               dim: e,
       ...
       function d(t, o) {
           ...
           if (r.total) {
               ...
               if (p[t].scrollPos !== e || p[t].scroll !== r.scroll || p[t].total !== r.total) {
                   ...
                   s !== m[t] && (i.toggleClass(n.prefix + "hidden" + o.suffix, s),
                   m[t] = s);
                   var l = e * r.ratio;
                   0 > l && (l = 0),
                   l > r.scroll - r.bar && (l = r.scroll - r.bar),
                   H[t][o.dim](r.bar).css(o.dir, n["offset" + o.Dir] + l)
               }
           }
       }
       function h() {
       ...
       if (n.horizontal && (u.x = e,
       p.x = {}),
       n.vertical && (u.y = r,
       p.y = {}),
       i.hasClass(n.prefix + "container") && f)
           return f.updateBars(),
           f;
       ...
       var g = t('<div class="' + n.prefix + 'inner" />').width(100).height(100).appendTo("body").css({
         ...
         , x = g.offsetWidth - g.clientWidth
         , D = g.offsetHeight - g.clientHeight;
       ...
       parseInt(b) && (i.css("maxHeight", "none"),
       v.css("maxHeight", b)),
       i.scrollTop(0);
       var y = t("body")
         , H = {};
